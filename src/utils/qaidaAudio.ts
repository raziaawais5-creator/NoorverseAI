...
export const QAIDA_VOICES_LIST: QaidaVoiceOption[] = [
  ...
  },
  {
    ...
    role: 'Golden Era Master & Majestic Tartil',
    description: 'World-renowned Egyptian master known for legendary breath control, majestic resonance, and crystal-clear letter articulation.',
    badge: 'Legendary Qari',
    preferredPitch: 0.94,
    preferredRate: 0.78,
  },
  {
